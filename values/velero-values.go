...
configuration:
  ...
  - name: clusterdiali
    ...
    credential:
      ...
      name: clusterdiali-backups-credentials
  ...
  #    apiTimeout:
  #    resourceGroup:
  #    The ID of the subscription where volume snapshots should be stored, if different from the cluster’s subscription. If specified, also requires configuration.volumeSnapshotLocation.config.resourceGroupto be set. (Azure only)
  #    subscriptionId:
  #    incremental:
  #    snapshotLocation:
  #    project:
